...
Taxi::Taxi()								// 4 a+b)
	:m_consumpKM(7.2/100), m_costKM(0.7), m_fuelMAX(75.0), m_mileageDAY(0.0), m_fuelACT(m_fuelMAX),
	m_balance(0.0){
}
Taxi::Taxi(const Taxi &car)																// 4 b) | copy-constructor
	:m_consumpKM(12.5 / 100), m_costKM(0.95), m_fuelMAX(90.0), m_mileageDAY(0.0), m_fuelACT(m_fuelMAX),
	m_balance(0.0) {
}
Taxi::~Taxi(){
}
